...
.classList, .methodList, .propertyList
{
...
.classList li, .methodList li, .propertyList li
{
	padding: 0;
	margin: 0 0 8px 0;
}
...
<hr />
			...
			<!-- method list -->
					...
					<ul class="methodList">
							...
							<li><a href="../symbols/Sfdc.canvas.oauth.html#checkChildWindowStatus">checkChildWindowStatus</a></li>
						
							<li><a href="../symbols/Sfdc.canvas.oauth.html#childWindowUnloadNotification">childWindowUnloadNotification</a></li>
						
							<li><a href="../symbols/Sfdc.canvas.oauth.html#instance">instance</a></li>
						
							<li><a href="../symbols/Sfdc.canvas.oauth.html#loggedin">loggedin</a></li>
						
							<li><a href="../symbols/Sfdc.canvas.oauth.html#login">login</a></li>
						
							<li><a href="../symbols/Sfdc.canvas.oauth.html#loginUrl">loginUrl</a></li>
						
							<li><a href="../symbols/Sfdc.canvas.oauth.html#logout">logout</a></li>
						
							<li><a href="../symbols/Sfdc.canvas.oauth.html#token">token</a></li>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				Sfdc.canvas.oauth
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/js_oauth.js.html">oauth.js</a>.
...
<!-- ============================== method details ========================= -->		
         ...
         User-Agent OAuth Authentication Flow to pass the OAuth token.
					...
					<pre class="code"><code>Sfdc.canvas.oauth.childWindowUnloadNotification(self.location.hash);</code></pre>
...
Never store OAuth tokens in cookies as this can lead to a security risk.</dd>
					...
					<pre class="code"><code>function clickHandler(e)
{
 var uri;
...
<!-- ============================== footer ================================= -->
		<div class="fineprint" style="clear:both">
			...
			Documentation generated by <a href="http://code.google.com/p/jsdoc-toolkit/" target="_blank">JsDoc Toolkit</a> 2.4.0 on Thu May 09 2013 12:02:03 GMT-0600 (MDT)
		</div>
	</body>
</html>
